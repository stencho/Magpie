...
namespace Magpie { 
    public class World {
        ...
        public bool running_slow => world_running_slow;
        bool world_running_slow = false;

        public bool match_external_fps_below_limit = false;

        public double last_tick_timer_val = 0;

        public double[] last_ticks = new double[200];
        public bool update_timer_tick = false;
        public double update_frame_rate_avg = 0;

        public double[] last_fps = new double[300];
        ...
        private void do_world_update() {            
            ...
            while (running) {
                Clock.internal_frame_probe.start_of_frame();
                ...
                Clock.internal_frame_probe.set("lights");
                foreach (DynamicLight light in current_map.lights) {
                    light.update();
                }


                Clock.internal_frame_probe.set("brushes");
                foreach (Brush brush in current_map.brushes.Values) {
                    brush.Update();
                }


                Clock.internal_frame_probe.set("objects");
                ...
                Clock.internal_frame_probe.set("actors");
                ...
                Clock.internal_frame_probe.set("frame_sleep");
                ...
                Clock.internal_frame_probe.set("frame_wake");
                ...
                loop_time = (DateTime.Now - dt).TotalMilliseconds - Clock.internal_frame_limit_ms;
                dt = DateTime.Now; 

                Clock.internal_frame_probe.end_of_frame(Clock.internal_frame_limit_ms);
